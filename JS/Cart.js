...
document.getElementById("remove-item-5").addEventListener("click", function (event) {
   event.preventDefault();
   removeFromCart('cart-item-5');
   location.reload();
});
document.getElementById("remove-item-6").addEventListener("click", function (event) {
   event.preventDefault();
   removeFromCart('cart-item-6');
   location.reload();
});
document.getElementById("remove-item-7").addEventListener("click", function (event) {
   event.preventDefault();
