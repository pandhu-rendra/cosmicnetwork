...
function setupPopup(openBtn, closeBtn, popup, overlay) {
  ...
  const popup6 = document.getElementById("benefits-6");
  const overlay6 = document.querySelector(".overlay");
  setupPopup(
    document.getElementById("open-popup-6"),
    document.getElementById("close-popup-6"),
    popup6,
    overlay6
  );

  const popup7 = document.getElementById("benefits-7");
  const overlay7 = document.querySelector(".overlay");
  setupPopup(
    document.getElementById("open-popup-7"),
    document.getElementById("close-popup-7"),
    popup7,
    overlay7
  );
  ...
  // BUY FOR ITEM SHOP 5
  buyItem(
      document.getElementById('buy-item-5'),
      'cart-item-5'
  );
  // BUY FOR ITEM SHOP 6
  buyItem(
      document.getElementById('buy-item-6'),
      'cart-item-6'
  );
  // BUY FOR ITEM SHOP 7
  buyItem(
